...
public class StockDao {
	 ...
	 */
	public int insertStock(Stock stock) throws ClassNotFoundException {
	 ...
	 * @return
	 */
	public String generateProductID(String productName)throws ClassNotFoundException {
		Connection conn = null;
		PreparedStatement pstmt = null;
	 ...
	 * @throws ClassNotFoundException 
	 */
	public int updateStock(String productID, int soldQty) throws ClassNotFoundException {
		Connection conn = null;
		PreparedStatement pstmt = null;
	 ...
	 * @throws ClassNotFoundException 
	 */
	public Stock getStock(String productID) throws ClassNotFoundException {
		Connection conn = null;
		PreparedStatement pstmt = null;
	 ...
	 * @return
	 */
	public int deleteStock(String productID)throws ClassNotFoundException {
		Connection conn = null;
		PreparedStatement pstmt = null;
