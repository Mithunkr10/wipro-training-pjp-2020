...
public class Administrator {
	 ...
	 * 
	 * If any of the above conditions fail return â€œData not Valid for insertionâ
	 * Else Return the generated ProductId 
	 * @param stock
	 * @return
	 * @throws ClassNotFoundException 
	 */
	public synchronized String insertStock(Stock stock) throws ClassNotFoundException {		
	 ...
	 * if delete is successful return â€œdeletedâ€�
	 * else return â€œrecord cannot be deletedâ€�
	 * @param ProductID
	 * @return
	 */
	public String deleteStock(String ProductID)throws ClassNotFoundException {		
	 ...
	 * 1. Sales obj should not be null else return â€œObject not valid for insertionâ€�
	 * 2. ProductID should be present in the TBL_STOCK table else return â€œUnknown 
	 * 	Product for salesâ€�
	 * 3. Products current QuatityOnHand value should be more than the QuantitySold value
	 * 	else return â€œNot enough stock on hand for salesâ€�
	 * 4. SalesDate should be current date or earlier date and not future date, 
	 * else return â€œInvalid dateâ€�
	 ...
	 * On successful completion of both the transaction return â€œSales Completedâ€�else â€œErrorâ€�.
	 * @param sales
	 * @return
	 * @throws ClassNotFoundException 
	 */
	public String insertSales(Sales sales) throws ClassNotFoundException {		
		if (sales == null) 
	 ...
	 * @throws ClassNotFoundException 
	 */
	public ArrayList<SalesReport> getSalesReport() throws ClassNotFoundException {	
